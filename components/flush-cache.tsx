...
export function FlushCache() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-white bg-opacity-0 px-4">
      <section className="w-full max-w-2xl p-8 md:p-12 lg:p-16 bg-white bg-opacity-0 rounded-xl">
